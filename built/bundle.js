...
var View = require('./main_view.jsx');


React.render(React.createElement(View, null), document.body);

},{"./main_view.jsx":5,"react":162}],2:[function(require,module,exports){
var React = require('react');
  ...
  render: function() {
    return (
      React.createElement("div", null, 
        React.createElement("span", null, React.createElement("b", null, "Hacker News")), 
        ...
        React.createElement("span", null, "|"), 
        React.createElement("span", null, "ask"), 
        React.createElement("span", null, "|"), 
        React.createElement("span", null, "jobs"), 
        React.createElement("span", null, "|"), 
  ...
  render: function() {
    {
      var ourList = this.props.posts.map(function(dataObj){
        return React.createElement(Post, {post: dataObj})
      })
    }
    return (
...
},{"./post.jsx":6,"react":162}],4:[function(require,module,exports){
var React = require('react');
var List  = require('./main_list.jsx');

var MainListContainer = React.createClass({displayName: "MainListContainer",
  getInitialState: function(){
   ...
   render: function() {
     return (
       React.createElement(List, {posts: this.state.posts})
     )
   }
})
...
},{"./main_list.jsx":3,"react":162}],5:[function(require,module,exports){
var React = require('react');
...
},{"./main_header.jsx":2,"./main_list_container.jsx":4,"react":162}],6:[function(require,module,exports){
var React = require('react');
  ...
  render: function() {
    return (
      React.createElement("li", null, 
        React.createElement("p", null, this.props.post.count, ". ", this.props.post.title), 
        React.createElement("p", null, this.props.post.points, " points by ", this.props.post.author, " ", this.props.post.time, " hour ago | ", this.props.post.comments, " comments")
      )
    )
  }
})
